...
namespace Kudan.AR
{
	public class Tracker : TrackerBase 
	{
		...
		/// </summary>         
		/// <param name="maxToTrack"></param>The maximum number of trackables which can be simultaneously tracked         
		public override void SetMaximumSimultaneousTracking(int maxToTrack)
		{
            #if UNITY_EDITOR || UNITY_IOS
			NativeInterface.SetMaximumSimultaneousTracking(maxToTrack);
            #elif UNITY_ANDROID
            if (m_KudanAR_Instance != null)
            {
                m_KudanAR_Instance.Call("SetMaximumSimultaneousTracking", maxToTrack);
            }
            #endif
		}         
		...
		public void UpdateRotation()
		{
			...
			_cameraBackgroundMeshFilter.mesh.SetVertices (pos);

			// Set UVs and Triangles to prev Unity 2018 format. 
			_cameraBackgroundMeshFilter.mesh.SetUVs (0, new Vector2[]
			{
				new Vector2 (0, 0),
					new Vector2 (1, 1),
					new Vector2 (1, 0),
			...
			_cameraBackgroundMeshFilter.mesh.triangles = new int[] { 0, 1, 2, 1, 0, 3 };
#else
